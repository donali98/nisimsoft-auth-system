...
public class TenantRoutingDataSource extends AbstractRoutingDataSource {
  ...
  public TenantRoutingDataSource(
      DataSource defaultDataSource, TenantDataSourceProvider tenantDataSourceProvider) {
  ...
  protected Object determineCurrentLookupKey() {
    ...
    if (tenantId == null) {
      ...
      return "default";
    } else System.out.println("Lookup tenant: " + tenantId);
    ...
    if (!tenantDataSources.containsKey(tenantId)) {
      try {
        ...
        System.err.println(
            "❌ Error al cargar DataSource para tenant " + tenantId + ": " + e.getMessage());
        return "default";
      }
    }
